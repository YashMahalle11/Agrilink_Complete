...
const Navbar = () => {
  ...
  className="text-green-700 hover:text-green-900 text-sm font-medium uppercase border border-green-600 px-3 py-1 rounded-lg hover:bg-green-600 hover:text-white transition"
>
...
>
  ...
  className="block text-green-700 font-semibold hover:text-green-900"
>
  🌾 Crop Price Prediction
</a>
